...
public final class ProtoBuf {
  ...
  public interface TypeOrBuilder extends 
    ...
    /**
     * <code>repeated .org.jetbrains.kotlin.metadata.Type nested_type = 15;</code>
     *
     * <pre>
     * Required only for union type
     * </pre>
     */
    ...
    /**
     * <code>repeated int32 nested_type_id = 16 [packed = true];</code>
     */
  ...
  public static final class Type extends
    ...
    public static final int NESTED_TYPE_ID_FIELD_NUMBER = 16;
    ...
    public void writeTo(org.jetbrains.kotlin.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < nestedType_.size(); i++) {
        output.writeMessage(15, nestedType_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < nestedType_.size(); i++) {
        size += org.jetbrains.kotlin.protobuf.CodedOutputStream
          .computeMessageSize(15, nestedType_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < nestedTypeId_.size(); i++) {
